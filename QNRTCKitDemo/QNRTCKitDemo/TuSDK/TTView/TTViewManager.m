...
- (void)setupSuperView:(UIView *)superView
{
    ...
    _filterPanelView = [TTFilterPanelView beautyPanelWithFrame:CGRectMake(0, KScreenHeight - 446, KScreenWidth, 246) beautyTarget:_beautyTarget];
    
    _filterPanelView.hidden = YES;
    [_superView addSubview:_filterPanelView];
    
    
    _stickerPanelView = [TTStickerPanelView beautyPanelWithFrame:CGRectMake(0, KScreenHeight - 500, KScreenWidth, 300) beautyTarget:self.beautyTarget];
    ...
    //美颜视图
    _beautyPanelView = [TTBeautyPanelView beautyPanelWithFrame:CGRectMake(0, KScreenHeight - 476, KScreenWidth, 276) beautyTarget:self.beautyTarget];
