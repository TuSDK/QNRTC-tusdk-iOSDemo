...
- (void)viewDidLoad {
    ...
    [[TTViewManager shareInstance] setupSuperView:(UIView *)self.preview];
}
...
- (void)localVideoTrack:(QNLocalVideoTrack *)localVideoTrack didGetPixelBuffer:(CVPixelBufferRef)pixelBuffer {
    ...
    CVPixelBufferRef processBuffer = [[[TTLiveMediator shareInstance] sendVideoPixelBuffer:pixelBuffer] getCVPixelBuffer];
